...
package com.medanis.myvideocallapplication.view
...
class CameraPreview(private val activity: Activity, private val cameraId: Int) : SurfaceView(activity), SurfaceHolder.Callback {
